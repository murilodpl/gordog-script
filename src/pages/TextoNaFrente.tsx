...
export default function TextoNaFrente() {
    const [data, setData] = useState({
        input: '',
        output: ''
    })
    const [caracter, setCaracter] = useState('1 ')
    ...
    function handleChange(e: any) {
        ...
        if (value != "") {
            setData({
                input: value,
                output: value.replace(reg, caracter)
            })
        } else {
            setData({
                input: '',
    ...
    return (
        <div className="container">
            <div className="countryDiv">
                <label htmlFor="caracter">Escolha um caracter para colocar na frente:
                    <input type="text" id="caracter" onChange={handleChangeCaracter} value={caracter} name="caracter" />
                </label>
            </div>

            <div className="divTextArea">
                <label htmlFor="input">Bota na frente: 🐒
