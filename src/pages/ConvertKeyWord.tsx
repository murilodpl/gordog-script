...
export default function ConvertKeyWord() {
    ...
    function downloadTxtFile() {
        ...
        element.download = "convert_keyword.txt";
    ...
    return (
        <div className="container">
            <div className="divTextArea">
                ...
                <label className='relative' htmlFor="output">Toma as KEY WORD: 😈 <span className='absolute top-0 right-0 text-g_red'>{resultLines}</span>
