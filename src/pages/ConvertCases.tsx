...
export default function ConvertAspas() {
    ...
    const options = [
        ...
        { value: 'sentence', text: 'Formato frase' },
        { value: 'lower', text: 'minúsculas' },
        { value: 'upper', text: 'MAIÚSCULAS' },
    ];
    ...
    useEffect(()=> {
        setData({
            input: data.input,
            output: changeDataBasedOnOption(data.input)
        })
    },[selectedOption])
    ...
    function handleChange(e: any) {
        ...
        setData({
            input: value,
            output: changeDataBasedOnOption(value)
        })
    }

    function changeDataBasedOnOption(dataString: string) {
        let dataStringChanged = '';

        switch (selectedOption) {
            case 'sentence':
                dataStringChanged = dataString.charAt(0).toUpperCase() + dataString.slice(1).toLowerCase();
                break;
            case 'lower':
                dataStringChanged = dataString.toLowerCase();
                break;
            case 'upper':
                dataStringChanged = dataString.toUpperCase();
                break;
    ...
    function downloadTxtFile() {
        ...
        element.download = "convertAspas.txt";
    ...
    return (
        <div className="container">
            ...
            <div className="mt-4 divTextArea">
                <label htmlFor="input">Escreva:
