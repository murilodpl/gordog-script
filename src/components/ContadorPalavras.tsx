    ...
    return (
        <div className="container">
            <div className="divTextArea">
                ...
                <label htmlFor="output"><div className='flex gap-4'>Total de palavras: <strong className='text-g_red'>{words}</strong></div>
