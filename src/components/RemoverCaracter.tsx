...
export default function RemoverCaracter() {
    const [data, setData] = useState({
        input: '',
        output: ''
    })
    const [caracter, setCaracter] = useState('●')
    let caracter_para_remover: any = caracter ? escapeRegExp(caracter) : '●';
    let reg: any = new RegExp(`${caracter_para_remover}+`, "g");
    ...
    function handleChangeCaracter(e: any) {
        const { value } = e.target;
        setCaracter(value);
    ...
    return (
        <div className="container">
            <div className="countryDiv">
                <label htmlFor="caracter">Escolha um caracter para remover:
                    <input type="text" id="caracter" onChange={handleChangeCaracter} value={caracter} name="caracter" />
                </label>
            </div>

            <div className="divTextArea">
                <label htmlFor="input">Remover caracter: ⚽
                ...
                <label htmlFor="output">Ta no gol: 🥅
